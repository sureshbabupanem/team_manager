...
class PhonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post phones_url, params: { phone: { number: @phone.number, person_id: @phone.person_id } }
    end
  ...
  test "should update phone" do
    patch phone_url(@phone), params: { phone: { number: @phone.number, person_id: @phone.person_id } }
